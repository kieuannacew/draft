        ...
        Project(
            ...
            tasks=[
                Task("Áp dụng kiểu (style) Title cho dòng đầu tiên “Báo cáo thường niên”.",
                     ...
                     'Put the cursor in the first line > Home > Styles group > Title.', chapter=2),
                Task("Áp dụng kiểu Heading 1 cho các dòng “Giới thiệu”, “Kết quả kinh doanh”, “Kế hoạch năm tới”.",
                     ...
                     'Put the cursor in each line > Home > Styles > Heading 1.', chapter=2),
                Task("Thay thế tất cả cụm từ “công ty ABC” thành “công ty XYZ”.",
                     ...
                     'Home > Replace (Ctrl+H) > Find: ABC, Replace: XYZ > Replace All.', chapter=2),
                Task("Chèn mục lục tự động (Table of Contents) vào đầu tài liệu.",
                     ...
                     'Put the cursor at the start of the document > References > Table of Contents > Automatic Table 1.', chapter=4),
                Task("Chèn số trang vào chân trang (footer).",
                     ...
                     'Insert > Page Number > Bottom of Page > Plain Number 2.', chapter=1),
                Task("Thêm watermark văn bản “BẢO MẬT”.",
                     ...
                     'Design > Watermark > Custom Watermark > Text watermark > Text: BẢO MẬT > OK.', chapter=1),
                Task("Đổi hướng trang của tài liệu thành ngang (Landscape).",
                     "Layout > Orientation > Landscape.",
                     chk_landscape,
                     'Change the orientation of the document to Landscape.',
                     'Layout > Orientation > Landscape.', chapter=1),
            ],
        ),
        Project(
            ...
            tasks=[
                Task("Căn giữa dòng tiêu đề “Thư mời hội thảo”.",
                     ...
                     'Put the cursor in the title line > Home > Center (Ctrl+E).', chapter=2),
                Task("Định dạng 3 dòng “Khai mạc”, “Báo cáo chuyên đề”, “Thảo luận và bế mạc” thành danh sách dấu đầu dòng.",
                     ...
                     'Select the 3 lines > Home > Bullets.', chapter=3),
                Task("Chuyển 4 dòng lịch trình (phân cách bằng Tab) thành bảng 3 cột.",
                     ...
                     'Select the 4 lines from “Thời gian…” to “10:30…” > Insert > Table > Convert Text to Table > Separate text at: Tabs > OK.', chapter=3),
                Task("Chèn chú thích cuối trang (footnote) sau “Quý đối tác” với nội dung “Danh sách đối tác đính kèm”.",
                     ...
                     'Put the cursor after “Quý đối tác” > References > Insert Footnote (Alt+Ctrl+F) > type the text.', chapter=4),
                Task("Đặt thuộc tính Title của tài liệu là “Thư mời hội thảo”.",
                     ...
                     'File > Info > Properties (on the right) > Title > type the text.', chapter=1),
                Task("Bật chế độ theo dõi thay đổi (Track Changes).",
                     "Review > Track Changes (Ctrl+Shift+E).",
                     chk_track_changes,
                     'Turn on Track Changes.',
                     'Review > Track Changes (Ctrl+Shift+E).', chapter=6),
            ],
        ),
    ],
)

        ...
        Project(
            ...
            tasks=[
                Task("Đổi tên trang tính “Sheet1” thành “DoanhSo”.",
                     ...
                     'Double-click the Sheet1 tab at the bottom (or right-click > Rename), type DoanhSo, press Enter.', chapter=1),
                Task("Trong ô E2:E11, nhập công thức tính Thành tiền = Số lượng × Đơn giá.",
                     ...
                     'Select E2, type =C2*D2, press Enter. Drag the fill handle (bottom-right corner) down to E11.', chapter=4),
                Task("Định dạng vùng A1:E11 thành bảng (Table) với kiểu bất kỳ, có hàng tiêu đề.",
                     ...
                     'Select A1:E11 > Home > Format as Table > choose a style > check ‘My table has headers’ > OK (or Ctrl+T).', chapter=3),
                Task("Cố định (freeze) hàng tiêu đề để luôn hiển thị khi cuộn.",
                     "View > Freeze Panes > Freeze Top Row.",
                     chk_freeze,
                     'Freeze the header row so it stays visible while scrolling.',
                     'View > Freeze Panes > Freeze Top Row.', chapter=1),
                Task("Áp dụng định dạng số có dấu phân cách hàng nghìn hoặc tiền tệ cho D2:E11.",
                     ...
                     'Select D2:E11 > Home > Number group > Comma Style (,) or Accounting/Currency.', chapter=2),
                Task("Ô G1 nhập “Tổng doanh thu”; ô G2 dùng hàm SUM tính tổng cột Thành tiền (E2:E11).",
                     ...
                     'Type Tổng doanh thu in G1. Select G2, type =SUM(E2:E11), press Enter.', chapter=4),
            ],
        ),
        Project(
            ...
            tasks=[
                Task("Ô D2:D11 dùng hàm IF: nếu Lương ≥ 10.000.000 thì “Cao”, ngược lại “Thấp”.",
                     ...
                     'Select D2, type =IF(C2>=10000000,"Cao","Thấp"), press Enter, drag down to D11.', chapter=4),
                Task("Sắp xếp dữ liệu (A1:D11) theo cột Lương giảm dần.",
                     ...
                     'Select a cell in the table > Data > Sort > Sort by: Lương, Order: Largest to Smallest > OK.', chapter=3),
                Task("Áp dụng định dạng có điều kiện (quy tắc bất kỳ) cho vùng C2:C11.",
                     ...
                     'Select C2:C11 > Home > Conditional Formatting > e.g. Data Bars or Highlight Cells Rules.', chapter=2),
                Task("Đặt tên vùng C2:C11 là “LuongNV”.",
                     ...
                     'Select C2:C11, type LuongNV in the Name Box (left of the formula bar), press Enter. Or Formulas > Define Name.', chapter=2),
                Task("Ô F2 dùng hàm COUNTIF đếm số nhân viên phòng “Kế toán” (vùng B2:B11).",
                     ...
                     'Select F2, type =COUNTIF(B2:B11,"Kế toán"), press Enter.', chapter=4),
                Task("Chèn biểu đồ cột (Clustered Column) thể hiện Lương theo Họ tên.",
                     ...
                     'Select A1:A11, hold Ctrl and select C1:C11 > Insert > Column Chart > Clustered Column.', chapter=5),
                Task("Đặt hướng trang in của trang tính là ngang (Landscape).",
                     "Page Layout > Orientation > Landscape.",
                     chk_landscape,
                     "Set the worksheet's print orientation to Landscape.",
                     'Page Layout > Orientation > Landscape.', chapter=1),
            ],
        ),
    ],
)

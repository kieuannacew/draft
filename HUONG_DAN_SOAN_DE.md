...
Trong thư mục app có sẵn thư mục `de_thi`. Tạo một thư mục con, ví dụ `de_thi\Excel_De2`.
Bạn có thể bấm nút **Thư mục đề** trên màn hình chính để mở nhanh `de_thi`.
